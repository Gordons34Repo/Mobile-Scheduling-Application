...
If I could go back, the one thing I would wanted to spent more time on would be the User Interface. I took this class with a different class solely on UI design, and there were a lot of UI/UX practices I would have wanted to apply to this project. A lot of the UI sections have bad sizing, and overlap some elements, and UI was our sole focus for sprint 4, along with exporting the schedule to a PDF.

I feel like this class gave a really good insight to what it's like in the workforce, as the client would come to us at the end of each sprint to point out things they didn't like, or that we missed. Recursion on a project was something I had never done before in school, and I'm glad I had this oppourtunity.
